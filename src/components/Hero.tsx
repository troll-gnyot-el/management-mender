      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-block animate-slide-down">
            <div className="px-3 py-1 text-xs font-medium bg-brand-green/10 text-brand-green rounded-full mb-6">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-6 animate-slide-down [animation-delay:100ms] text-balance">
            Manage your finances with <span className="text-brand-green">unparalleled</span> ease
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-slide-down [animation-delay:300ms]">
            <Button size="lg" className="rounded-full text-base h-12 px-8 bg-brand-green hover:bg-brand-green/90 group">
              <Link to="/signup" className="flex items-center">
                Get Started Free
                <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" className="rounded-full text-base h-12 px-8 border-brand-green text-brand-green hover:bg-brand-green/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 animate-slide-up [animation-delay:400ms]">
            <div className="p-4 rounded-xl bg-white/50 dark:bg-black/50 backdrop-blur-sm border border-brand-green/10">
              <Smartphone className="w-8 h-8 text-brand-green mb-3 mx-auto" />
              <h3 className="font-medium mb-2">Mobile Banking</h3>
              <p className="text-sm text-muted-foreground">Bank anytime, anywhere with our mobile-first approach</p>
            </div>
