...
const Login = () => {
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    ...
    toast({
      ...
      description: "Welcome back to SquirrelBank!",
    });
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Or{" "}
              <Link to="/signup" className="font-medium text-finance-green hover:text-finance-green/90">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="mt-8 space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm">
                  <Link to="/forgot-password" className="font-medium text-finance-orange hover:text-finance-orange/90">
